    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <span className="text-[10px] font-mono opacity-40 uppercase">Simulation Mode</span>
            </div>
            ...
            <div className="mt-8 p-4 bg-gray-50/50 rounded-xl border border-gray-100 flex gap-4 items-start animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-text-muted leading-relaxed italic">
                        The "projections" above are semantic reconstructions of the model's internal stereotypes. 
                        We first ask the language model to <strong>imagine</strong> the prompt in detail, then use 
                        <strong> CLIP Multimodal Alignment</strong> to retrieve the most semantically similar 
                        archetype from its training/latent space. This reveals the model's hidden associations 
                        without the high compute cost of full image generation.
                    </p>
                </div>
            </div>
        </div>
