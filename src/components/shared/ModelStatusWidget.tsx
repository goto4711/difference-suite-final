...
import type { WorkerStatus } from '../../core/inference/types';
...
export const ModelStatusWidget = () => {
    ...
    useEffect(() => {
        ...
        const fetchStatus = async () => {
            try {
                const res = await transformersClient.getStatus();
    ...
    const totalMem = status?.loadedModels.reduce((acc, m) => acc + (m.memoryFootprintMB || 0), 0) || 0;
