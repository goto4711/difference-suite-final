...
**Route:** `/deep-vector-mirror` · **Models:** BGE-Small-EN-v1.5 / CLIP ViT-B/32 (vectors), BERT-base-uncased (attention) · **Key dependencies:** `@huggingface/transformers`, D3.js · **Archival site:** Holocaust archives (cross-cutting) · **Try it with:** `difference-suite-testdata/texts/holocaust-texts/` and `images/animals/`
