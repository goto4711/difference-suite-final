...
**Route:** `/detail-extractor` · **Model:** BGE-Small-EN-v1.5 (Transformers.js v4, feature-extraction) · **Key dependencies:** `@huggingface/transformers`, custom K-means + 2D projection · **Archival site:** Holocaust archives · **Try it with:** `difference-suite-testdata/texts/holocaust-texts/`
